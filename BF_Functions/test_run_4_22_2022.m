...
ImageAnalyses=    {
                    {{'Nuc'},{1},{4 0.1},{3},{'Nuc_bw4_perim' [0.8500 0.3250 0.0980]},{true},{}};
                    {{'Cyt'},{2},{1 0.3},{2},{},{true},{}};
...
for j=201% Number of wells in ND2 File  
    % Set Current Well and other important values
    %##Would be very useful to figure out how to make this work as 
    %loop, but might be quite difficult
    CurrSeries=j-1; %The current well that we're looking at
...
for i=0:1 %For all of the time points in the series, should start at zero if T_Value has -1 built in, which it should
...
%                     Storage
                    switch Analysis
                        ...
                        case 'CytWS'
                         [CytWS_bw4,bw4_perim] = CytNucWaterShed(Nuc_bw4,Cyt,Cyt_bw4);
                         CytWS_Label=Label;
