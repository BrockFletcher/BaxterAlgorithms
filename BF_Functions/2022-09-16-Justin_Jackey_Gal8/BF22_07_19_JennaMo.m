...
%% Image Folder Location 
    ...
    %export to.
clc, clear, close all
ImgFile=char("D:\Dropbox (VU Basic Sciences)\Duvall Confocal\Duvall Lab\Brock Fletcher\JennaMosierColab\Brock examples\New folder\Experiment-91-Split Scenes-01.czi");
